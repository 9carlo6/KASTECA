...
public class PostActivityRispostaCommentoStudenteTest {
    ...
    public void controllInteface() throws InterruptedException{
        ...
        onView(withText("Rispondi"))
                .check(matches(isDisplayed()));
        //onView(withText("Elimina"))       NON c'è nessun commento dello studente
          //      .check(matches(isDisplayed()));
    ...
    @Test
    public void creazioneModificaEliminazioneRisposta() throws InterruptedException{
