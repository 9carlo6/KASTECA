...
@LargeTest
public class InfoRichiestaStudenteActivityTest {
    ...
    @Rule
    public ActivityTestRule<InfoRichiestaStudenteActivity> infoRichiestaStudenteActivityActivityTestRule = new ActivityTestRule<>(InfoRichiestaStudenteActivity.class, false, false);
    ...
    @Test()
    public void InfoRichiestaActivityTestAccettaRichiesta() throws InterruptedException {
        ...
        i.putExtra("id_richiesta", "id_richiesta_prova");
        i.putExtra("data_richiesta", "data_richiesta");

        infoRichiestaStudenteActivityActivityTestRule.launchActivity(i);
        ...
        ViewInteraction button = onView(withText("ACCETTA RICHIESTA"));
        button.perform(click());
    }

    @Test()
    public void InfoRichiestaActivityTestRifiutaRichiesta() throws InterruptedException {
        ...
        ViewInteraction button = onView(withText("RIFIUTA RICHIESTA"));
        button.perform(click());
    }
