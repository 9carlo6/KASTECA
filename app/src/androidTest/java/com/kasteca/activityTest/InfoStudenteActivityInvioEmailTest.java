...
@LargeTest
public class InfoStudenteActivityInvioEmailTest {
    ...
    @Test()
    public void InfoStudenteActivityInvioEmailTest() throws InterruptedException {
        ...
        onView(withId(R.id.bottone_email)).perform(click());
    }
