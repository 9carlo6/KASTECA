...
public class LoadDocenteCorsiTest {
    ...
    public void loadDocenteCorsiTest() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.Email_Edit_Text),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("zimeo@unisa"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.Email_Edit_Text), withText("zimeo@unisa"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.Email_Edit_Text), withText("zimeo@unisa"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("zimeo@unisannio.it"));
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.reclycleview),
                        childAtPosition(
                                childAtPosition(
